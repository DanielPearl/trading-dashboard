...
def _load_upstream(repo_path: str) -> dict[str, Callable[..., Any]]:
    ...
    # api_tennis_live was removed on 2026-07-08 together with the
    # in-match adjustment layer. collapse_to_matches now defaults
    # live_state_by_key to None (a no-op that zero-fills the in-match
    # fields the pre-match panel never reads).
