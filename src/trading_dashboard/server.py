...
def serve(host: str, port: int, bots: List[dict], risk_caps: dict,
    ...
    if gdp_trader_cfg:
        from .bots import gdp as gdp_bot
        gdp_bot.start_daemon(gdp_trader_cfg)
    if pce_trader_cfg:
...
def main(argv: list[str] | None = None) -> int:
    ...
    gdp_trader_cfg = cfg.raw.get("gdp_trader") or {}
