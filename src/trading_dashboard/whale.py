...
_EXCLUDED_SERIES_PREFIXES = (
    ...
    "KXEUROPALG", "KXBUNDESLIGA", "KXLALIGA", "KXSERIEA", "KXLIGUE1",
    "KXRUGBY", "KXAFL", "KXCFL",
    # Cricket
    "KXIPL", "KXIPLGAME", "KXCRICKET", "KXT20", "KXTEST", "KXBBL", "KXPSL",
    "KXICC", "KXASIACUP",
    ...
    "KXF1", "KXMOTOGP", "KXNASCAR", "KXINDYCAR", "KXTOURDEFRANCE",
    "KXOLYMPICS",
    # Esports
    "KXESPORTS", "KXCSGO", "KXDOTA", "KXLOL", "KXVALORANT",
    ...
    "KXSOL", "KXSOLD", "KXSOLM", "KXXRP", "KXXRPD",
    "KXDOGE", "KXLTC", "KXADA", "KXMATIC",
    "KXCRYPTO",
)
